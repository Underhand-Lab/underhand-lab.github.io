// pose_bone_frame_maker.js

// OpenCV.js가 전역 cv 객체를 노출한다고 가정합니다.
// HTML 파일에 <script src="https://docs.opencv.org/4.7.0/opencv.js"></script>를 추가해야 합니다.

// config 모듈에서 필요한 상수들을 가져옵니다.
// 이 부분은 config.js 파일로 별도 구현해야 합니다.
/*
const config = {
    MODEL_CONFIG: {
        MIN_DRAW_VISIBILITY: 0.5
    },
    JOINTS: {
    ...
    CONNECTIONS_COLORS: {
        'left_shoulder,left_elbow': [255, 0, 0, 255], // RGBA
        // ...
    }
};
*/
...
class IPoseFrameMaker {
    // get_size(), get_img_at() 등의 메서드들을 정의할 수 있습니다.
}

// Python의 PoseFrameMaker 클래스를 JavaScript로 변환
export class PoseFrameMaker extends IPoseFrameMaker {
    constructor() {
        super();
